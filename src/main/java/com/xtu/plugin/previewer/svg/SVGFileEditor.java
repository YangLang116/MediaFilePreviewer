...
public class SVGFileEditor extends UserDataHolderBase implements FileEditor {
    ...
    private JComponent getErrorPanel() {
        JLabel errorLabel = new JLabel("Fail to load SVG Image", Messages.getErrorIcon(), SwingConstants.CENTER);
    ...
    private String getImageInfo(BufferedImage image) {
        ...
        return String.format("%dx%d SVG (%d-bit color) %s", width, height, imageMode, imageSize);
    }
    ...
    private BufferedImage loadImage() {
        try {
            ...
            LogUtils.error("SVGFileEditor loadImage: " + e.getMessage());
            return null;
        }
    }
